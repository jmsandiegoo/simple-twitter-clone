...
export function Logo({className, fill, width, maxWidth, height}) {
  return (
    <IconContainer className={className} fill={fill} maxWidth={maxWidth} width={width} height={height}>
...
export function Exit({className, onClick, fill, width, maxWidth, height}) {
  return (
    <IconContainer className={className} onClick={onClick} fill={fill} maxWidth={maxWidth} width={width} height={height} cursor="pointer">
      <svg viewBox="0 0 24 24">
